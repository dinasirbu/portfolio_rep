import { CASE_STUDY_TEXT } from './caseStudyText';
...
export const WORKS = [
  // Branding Projects
  {
    ...
    category: 'Branding',
    cover: {
      src: '/portfolio_rep/branding/granier-presentation/granier-03.jpg',
      alt: 'Granier brand identity',
    },
    caseStudy: {
      client: 'Granier',
      ...
      year: '2024',
      summary:
        'Comprehensive brand identity system including logo design, color palette, typography, and brand guidelines for a modern lifestyle brand.',
      objectives: [
      ...
      gallery: Array.from({ length: 23 }, (_, i) => ({
        src: `/portfolio_rep/branding/granier-presentation/granier-${String(
          i + 1
        ).padStart(2, '0')}.jpg`,
      ...
      fullText: CASE_STUDY_TEXT['branding-granier'],
    },
  },
  {
    id: 'branding-renee',
    ...
    category: 'Branding',
    cover: {
      src: '/portfolio_rep/branding/renee-presentation/renee-03.jpg',
      alt: 'Renee brand identity',
    },
    caseStudy: {
      client: 'Renee',
      ...
      year: '2024',
      summary:
        'Sophisticated brand identity design featuring elegant typography, refined color palette, and comprehensive visual guidelines.',
      objectives: [
      ...
      gallery: Array.from({ length: 20 }, (_, i) => ({
        src: `/portfolio_rep/branding/renee-presentation/renee-${String(
          i + 1
        ).padStart(2, '0')}.jpg`,
        alt: `Renee brand presentation ${i + 1}`,
      })),
      tags: ['Brand Identity', 'Logo Design', 'Typography', 'Brand Guidelines'],
      fullText: CASE_STUDY_TEXT['branding-renee'],
    },
  },
  ...
  // Logo Projects
  {
    ...
    category: 'Logo',
    cover: {
      src: '/portfolio_rep/logo/concept-store-presentation/concept-store-03.jpg',
      alt: 'Concept Store logo',
    },
    caseStudy: {
      ...
      year: '2024',
      summary:
        'Modern logo design for a contemporary retail concept, featuring clean typography and distinctive visual mark.',
      objectives: [
      ...
      gallery: Array.from({ length: 16 }, (_, i) => ({
        src: `/portfolio_rep/logo/concept-store-presentation/concept-store-${String(
          i + 1
        ).padStart(2, '0')}.jpg`,
        alt: `Concept Store logo presentation ${i + 1}`,
      })),
      tags: ['Logo Design', 'Brand Mark', 'Typography', 'Visual Identity'],
      fullText: CASE_STUDY_TEXT['logo-concept-store'],
    },
  },
  ...
  // Packaging Projects
  {
    ...
    category: 'Packaging',
    cover: {
      src: '/portfolio_rep/packaging/apifera-3-jars-presentation/apifera-3-jars-03.jpg',
      alt: 'Apifera 3 jars packaging',
    },
    caseStudy: {
      client: 'Apifera',
      ...
      year: '2024',
      summary:
        'Elegant packaging design for premium skincare product set, featuring sophisticated typography and sustainable materials.',
      objectives: [
      ...
      gallery: Array.from({ length: 19 }, (_, i) => ({
        src: `/portfolio_rep/packaging/apifera-3-jars-presentation/apifera-3-jars-${String(
          i + 1
        ).padStart(2, '0')}.jpg`,
      ...
      fullText: CASE_STUDY_TEXT['packaging-apifera-3jars'],
    },
  },
  {
    ...
    category: 'Packaging',
    cover: {
      src: '/portfolio_rep/packaging/apifera-hexagon-presentation/apifera-hexagon-01.jpg',
      alt: 'Apifera hexagon packaging',
    },
    caseStudy: {
      client: 'Apifera',
      ...
      year: '2024',
      summary:
        'Innovative hexagonal packaging design that stands out on shelf while maintaining brand consistency and premium feel.',
      objectives: [
      ...
      gallery: Array.from({ length: 14 }, (_, i) => ({
        src: `/portfolio_rep/packaging/apifera-hexagon-presentation/apifera-hexagon-${String(
          i + 1
        ).padStart(2, '0')}.jpg`,
      ...
      fullText: CASE_STUDY_TEXT['packaging-apifera-hexagon'],
    },
  },
  {
    ...
    category: 'Packaging',
    cover: {
      src: '/portfolio_rep/packaging/lunchemeat-presentation/Lunchemeat-01.jpg',
      alt: 'Lunchemeat packaging',
    },
    caseStudy: {
      client: 'Lunchemeat',
      ...
      year: '2024',
      summary:
        'Appetizing packaging design for meat products, balancing appetizing visuals with clear product information and brand identity.',
      objectives: [
      ...
      gallery: Array.from({ length: 12 }, (_, i) => ({
        src: `/portfolio_rep/packaging/lunchemeat-presentation/Lunchemeat-${String(
          i + 1
        ).padStart(2, '0')}.jpg`,
      ...
      fullText: CASE_STUDY_TEXT['packaging-lunchemeat'],
    },
  },
  {
    id: 'packaging-selik',
    ...
    category: 'Packaging',
    cover: {
      src: '/portfolio_rep/packaging/selik-presentation/Selik-01.jpg',
      alt: 'Selik packaging',
    },
    caseStudy: {
      client: 'Selik',
      ...
      year: '2024',
      summary:
        'Clean and modern packaging design that emphasizes product quality and brand trustworthiness.',
      objectives: [
      ...
      gallery: Array.from({ length: 17 }, (_, i) => ({
        src: `/portfolio_rep/packaging/selik-presentation/Selik-${String(
          i + 1
        ).padStart(2, '0')}.jpg`,
      ...
      fullText: CASE_STUDY_TEXT['packaging-selik'],
    },
  },
  {
    ...
    category: 'Packaging',
    cover: {
      src: '/portfolio_rep/packaging/sousages-presentation/crenvurști-01.jpg',
      alt: 'Sousages packaging',
    },
    caseStudy: {
      client: 'Sousages',
      ...
      year: '2024',
      summary:
        'Traditional yet modern packaging design for artisanal sausages, balancing heritage with contemporary appeal.',
      objectives: [
      ...
      gallery: Array.from({ length: 13 }, (_, i) => ({
        src: `/portfolio_rep/packaging/sousages-presentation/crenvurști-${String(
          i + 1
        ).padStart(2, '0')}.jpg`,
      ...
      fullText: CASE_STUDY_TEXT['packaging-sousages'],
    },
  },
  {
    id: 'packaging-tirol',
    ...
    category: 'Packaging',
    cover: {
      src: '/portfolio_rep/packaging/tirol-presentation/TIROL-01.jpg',
      alt: 'Tirol packaging',
    },
    caseStudy: {
      client: 'Tirol',
      ...
      year: '2024',
      summary:
        'Regional identity packaging design that celebrates local heritage while ensuring modern market appeal.',
      objectives: [
      ...
      gallery: Array.from({ length: 7 }, (_, i) => ({
        src: `/portfolio_rep/packaging/tirol-presentation/TIROL-${String(
          i + 1
        ).padStart(2, '0')}.jpg`,
      ...
      fullText: CASE_STUDY_TEXT['packaging-tirol'],
    },
  },
  ...
  // Social Media Projects
  {
    ...
    cover: {
      src: '/portfolio_rep/social-media/esterra-park-presentation/esterra-park--01.jpg',
      alt: 'Esterra Park social media',
    },
    caseStudy: {
      client: 'Esterra Park',
      ...
      year: '2024',
      summary:
        'Engaging social media content for residential development, showcasing lifestyle and community features.',
      objectives: [
      ...
      gallery: Array.from({ length: 4 }, (_, i) => ({
        src: `/portfolio_rep/social-media/esterra-park-presentation/esterra-park--${String(
          i + 1
        ).padStart(2, '0')}.jpg`,
      ...
      fullText: CASE_STUDY_TEXT['social-esterra-park'],
    },
  },
  {
    ...
    category: 'Social Media',
    cover: {
      src: '/portfolio_rep/social-media/laur-gifts-presentation/laurgifts-01.jpg',
      alt: 'Laur Gifts social media',
    },
    caseStudy: {
      client: 'Laur Gifts',
      ...
      year: '2024',
      summary:
        'Feminine and warm social media content featuring lifestyle photography and elegant typography for gift brand.',
      objectives: [
      ...
      gallery: Array.from({ length: 6 }, (_, i) => ({
        src: `/portfolio_rep/social-media/laur-gifts-presentation/laurgifts-${String(
          i + 1
        ).padStart(2, '0')}.jpg`,
      ...
      fullText: CASE_STUDY_TEXT['social-laur-gifts'],
    },
  },
  {
    ...
    category: 'Social Media',
    cover: {
      src: '/portfolio_rep/social-media/swiss-village-presentation/swiss-village-01.jpg',
      alt: 'Swiss Village social media',
    },
    caseStudy: {
      ...
      year: '2024',
      summary:
        'Professional social media content for ecological residential project, emphasizing sustainability and modern living.',
      objectives: [
      ...
      gallery: Array.from({ length: 5 }, (_, i) => ({
        src: `/portfolio_rep/social-media/swiss-village-presentation/swiss-village-${String(
          i + 1
        ).padStart(2, '0')}.jpg`,
      ...
      fullText: CASE_STUDY_TEXT['social-swiss-village'],
    },
  },
];
