...
import { CONTACT_INFO, CONTACT_CONTENT } from "../../config/siteConfig";
import useContactForm from '../../hooks/useContactForm';

/**
 * Contact Section Component
 * 
 * TO EDIT CONTENT: Go to src/config/siteConfig.js and edit CONTACT_CONTENT
 * 
 * Features:
    ...
    <section id="contact" className="contact-section" ref={ref}>
      <div className="contact-container">
        ...
        <div className="contact-grid">
          ...
          >
            <h3 className="contact-info-title">{CONTACT_CONTENT.info.title}</h3>
          ...
          >
            <h3 className="form-title">{CONTACT_CONTENT.form.title}</h3>

            <div className="form-group">
              <input
                type="text"
                name="name"
                placeholder={CONTACT_CONTENT.form.placeholders.name}
                value={formData.name}
            ...
            <div className="form-group">
              <input
                type="text"
                name="subject"
                placeholder={CONTACT_CONTENT.form.placeholders.subject}
            ...
            <div className="form-group">
              <textarea
                name="message"
                placeholder={CONTACT_CONTENT.form.placeholders.message}
                rows="5"
            ...
            {submitStatus === "success" && (
              ...
              >
                ...
                <span>{CONTACT_CONTENT.form.messages.success}</span>
              </motion.div>
            )}
            ...
            {submitStatus === "error" && (
              ...
              >
                ...
                <span>{CONTACT_CONTENT.form.messages.error}</span>
              </motion.div>
            )}
