...
export const ABOUT_CONTENT = {
  ...
  sectionSubtitle: "Passionate graphic designer with expertise in branding and packaging design",
  ...
  cta: {
    ...
    description: "I'm always excited to take on new projects and collaborate with creative minds.",
...
export const PORTFOLIO_CONTENT = {
  ...
  sectionSubtitle: "Explore my creative work across branding, packaging, and digital design. Each project represents a unique challenge and creative solution.",
...
export const CONTACT_CONTENT = {
  ...
  sectionSubtitle: "Ready to bring your vision to life? I'm always excited to collaborate on new projects.",
  
  info: {
    title: "Get In Touch",
    description: "Whether you have a specific project in mind or just want to discuss ideas, I'd love to hear from you. Let's create something amazing together.",
  ...
  form: {
    ...
    messages: {
      success: "Thank you! I've received your message and will respond within 24 hours.",
...
export const FOOTER_CONTENT = {
  brandTitle: "Creative",
  brandDescription: "Passionate graphic designer creating compelling visual identities and packaging designs.",
